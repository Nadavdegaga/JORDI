...
const executives = [
  { role: "שותף מייסד", title: 'הנהלה ומו"פ', name: "ירדן טייר", image: yardenPhoto, imagePos: "center 30%", bio: "בוגרת תואר במדעי המחשב ומהנדסת תוכנה בחברות מובילות. שירתה 6.5 שנים בצה״ל מצוב ועד תפקידי פיקוד. מובילה את מחלקת המחקר והפיתוח עם ניסיון בבינה עסקית, ניתוח נתונים ופתרונות דיגיטליים מתקדמים." },
